          ...
          <div className='md:7/12 lg:w-1/2'>
            ...
            <p className='my-8 text-gray-600 dark:text-gray-300'>
              <span className='text-gray-50 font-bold'>
                2023-yil iyun, iyul, avgust
              </span>{' '}
              <br />
              Universitet hududi va unga tutash 5 ta mahallada o`rganishlar olib
              borish
              <br />
              <br />
              <span className='text-gray-50 font-bold'>
              ...
              <br />
              Yoshlar ishlari agentligi, Tabiar resurlari vazirligi va Egologik
              partiya bilan shartnomalr qilish
              <br />
              <br />
              <span className='text-gray-50 font-bold'>
                Darslik, qo`llanma
              ...
              <br />
              Daraxtlarni o`rganish va platformaga joylashtirish, shuningdek
              daraxtlarni qiymatini keltirib chiqarish bo`yicha qo`llanma
              yaratish
              <br />
              <br />
              <span className='text-gray-50 font-bold'>
              ...
              <br />
              Jarima tortish usulini takomillashtirish va har bir ekilgan
              darxtga rag`bat bershini shakllantirish
            </p>
              ...
              <div className='mt-8 flex gap-4 md:items-center'>
                ...
                <div className='w-5/6'>
                  ...
                  <p className='text-gray-500 dark:text-gray-400'>
                    Oddiy aholi real vaqtda Daraxtlarni himoya qila oladi
                  </p>
                </div>
              </div>
